...
##Plotting
png(file = "plot4.png", width = 480, height = 480) ## Open PDF device and create a file
## Set for 2 row and 2 columns
par(mfrow = c(2, 2))

## Global Active Power
plot(hpc_dataset$datetime, hpc_dataset$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

## Voltage
plot(hpc_dataset$datetime, hpc_dataset$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(hpc_dataset$datetime, hpc_dataset$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
